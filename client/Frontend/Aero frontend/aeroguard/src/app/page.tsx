    ...
    <section className="relative flex min-h-screen items-center overflow-hidden">
      ...
      <div className="relative mx-auto flex w-full max-w-[1200px] items-center gap-16 px-6 pt-[56px]">
        ...
        <div className="flex-1 max-w-[560px]">
          <div
            className="mb-4 inline-flex items-center gap-2 rounded-full border border-border-subtle bg-surface px-3 py-1"
          >
          ...
          <p className="mb-8 max-w-[460px] text-[17px] leading-[1.7] text-text-secondary">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/app/dashboard"
              className="flex items-center gap-2 rounded-md bg-accent px-5 py-2.5 text-[14px] font-medium text-white transition-colors hover:bg-accent-hover"
            >
              Start Free Trial
              <ArrowRight className="h-4 w-4" />
            </Link>
            <button className="flex items-center gap-2 rounded-md border border-border-default px-5 py-2.5 text-[14px] font-medium text-text-secondary transition-colors hover:border-border-strong hover:text-text-primary">
              <Play className="h-3.5 w-3.5" />
              Watch Demo
            </button>
          </div>

          <div className="mt-10 flex items-center gap-6 text-[12px] text-text-tertiary">
