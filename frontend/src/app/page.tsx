      ...
      <div className="mx-auto max-w-[1200px] px-6">
        ...
        <div className="grid gap-3 sm:gap-4 grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
          {steps.map((step) => (
            <div
              key={step.num}
              className="group card relative overflow-hidden p-3 sm:p-6 hover-lift hover:shadow-md"
            >
              ...
              <div className="relative z-10">
                <span className="mb-2 sm:mb-3 block font-mono text-[10px] sm:text-[12px] text-accent transition-colors duration-[600ms] group-hover:text-white">{step.num}</span>
                <h3 className="mb-1 sm:mb-2 text-[13px] sm:text-[16px] font-bold text-text-primary transition-all duration-[600ms] group-hover:text-white group-hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)] leading-tight">{step.title}</h3>
                <p className="text-[11px] sm:text-[13px] leading-[1.4] sm:leading-[1.6] text-text-secondary transition-all duration-[600ms] group-hover:text-white group-hover:drop-shadow-[0_0_6px_rgba(255,255,255,0.4)]">{step.desc}</p>
              </div>
            </div>
          ))}
        </div>
